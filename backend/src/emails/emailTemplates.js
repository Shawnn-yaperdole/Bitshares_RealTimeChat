...
export function createWelcomeEmailTemplate(name, clientURL) {
  ...
  <head>
    ...
    <title>Welcome to Blinc Technologies</title>
  </head>
  <body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f5f5f5;">
    <div style="background: linear-gradient(to right, #8E2DE2, #FF5F6D); padding: 30px; text-align: center; border-radius: 12px 12px 0 0;">
      ...
      <h1 style="color: white; margin: 0; font-size: 28px; font-weight: 500;">Welcome to Blinc Technologies!</h1>
    </div>
    <div style="background-color: #ffffff; padding: 35px; border-radius: 0 0 12px 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
      <p style="font-size: 18px; color: #8E2DE2;"><strong>Hello ${name},</strong></p>
      <p>We're excited to have you join our platform! Blinc Technologies chat connects you with other users, staff, and colleagues in real-time, no matter where they are.</p>
      ...
      <p style="margin-top: 25px; margin-bottom: 0;">Best regards,<br>Blinc Technologies Team</p>
    </div>
    
    <div style="text-align: center; padding: 20px; color: #999; font-size: 12px;">
      <p>© 2026 Blinc Technologies. All rights reserved.</p>
      <p>
